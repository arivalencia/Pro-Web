                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" name="Direcciones" class="form-control" placeholder="">
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label>Facturacion</label>
                                                <input type="number" name="Facturacion" class="form-control" placeholder="">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-4">
                                                <label>Fax</label>
                                                <input type="Number" name="Fax" class="form-control" placeholder="">
                                            </div>
                                            <div class="form-group col-md-4">
                                                <label>Catalogo</label>
                                                <input type="text" name="Catalogo" class="form-control" placeholder="">
                                            </div>
                                        </div>
